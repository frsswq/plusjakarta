...
const FontShowcaseSliderSize = ({
	...
	return (
		<div
			className="group/slider flex h-9 w-[350px] items-center gap-2 rounded-xs bg-transparent px-3 whitespace-nowrap
				antialiased"
		>
			...
			/>
			<span
				className="text-sm font-normal tracking-tight text-zinc-700 tabular-nums group-hover:font-[450]
					group-hover/slider:text-black"
			>
				{value}px
			</span>
		</div>
