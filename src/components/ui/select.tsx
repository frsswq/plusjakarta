...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      focus:ring-ring flex h-9 w-full items-center justify-between rounded-md border
      bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-sm focus:ring-1
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      items-center rounded-sm py-1.5 pr-8 pl-2 text-sm outline-none select-none
